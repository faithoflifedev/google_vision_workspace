...
FaceAnnotation _$FaceAnnotationFromJson(Map<String, dynamic> json) =>
    FaceAnnotation(
      ...
      enumJoyLikelihood: $enumDecode(_$LikelihoodEnumMap, json['joyLikelihood'],
          unknownValue: Likelihood.UNKNOWN),
      enumSorrowLikelihood: $enumDecode(
          _$LikelihoodEnumMap, json['sorrowLikelihood'],
          unknownValue: Likelihood.UNKNOWN),
      enumAngerLikelihood: $enumDecode(
          _$LikelihoodEnumMap, json['angerLikelihood'],
          unknownValue: Likelihood.UNKNOWN),
      enumSurpriseLikelihood: $enumDecode(
          _$LikelihoodEnumMap, json['surpriseLikelihood'],
          unknownValue: Likelihood.UNKNOWN),
      enumUnderExposedLikelihood: $enumDecode(
          _$LikelihoodEnumMap, json['underExposedLikelihood'],
          unknownValue: Likelihood.UNKNOWN),
      enumBlurredLikelihood: $enumDecode(
          _$LikelihoodEnumMap, json['blurredLikelihood'],
          unknownValue: Likelihood.UNKNOWN),
      enumHeadwearLikelihood: $enumDecode(
          _$LikelihoodEnumMap, json['headwearLikelihood'],
          unknownValue: Likelihood.UNKNOWN),
    );
